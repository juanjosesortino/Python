# Aplicacion de escritorio con TKInter integrada con Python
# Hay muchos mas framework y bibliotecas para hacer esto

# Base de datos con SQLite
# https://www.sqlite.org/index.html

# Visor de base de datos DBBrowser for SQLite
